...
public class RPG_inventory_setup : MonoBehaviour
{
    // 슬롯 오브젝트 담음
    ...
    public void Create_crafting_set()
    {
        ...
        {
            // 슬롯 오브젝트 세팅
            GameObject tmp_obj = Instantiate(Equipment_UI_manager.instance.slot_obj, Equipment_UI_manager.instance.Get_parent_obj(0));
